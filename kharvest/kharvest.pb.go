...
func (NotifyReply_Action) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{1, 0} }
...
func (StoreReply_Action) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{3, 0} }
...
func (*DataSignature) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (m *DataSignature) GetTimestamp() *google_protobuf.Timestamp {
	if m != nil {
		return m.Timestamp
	}
	return nil
...
func (*NotifyReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*StoreReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
var fileDescriptor0 = []byte{
	...
	,
}
